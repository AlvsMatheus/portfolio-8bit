...
import Button from '../components/Button.jsx';
 ...
 const Footer = ({onScrollBack, onScrollNext}) => {
  ...
  const moonRef = useRef(null); // <== ADICIONE ISSA LINHA
 ...
 return (
    <section id="footer" className="section overflow-hidden">
      ...
      <div className="absolute z-10 top-10 -left-260 w-1000 h-960 xl:w-1200 rounded-full bg-[url('/images/star-background.png')] bg-bottom"/>
      <div 
      ref={moonRef}
      onClick={() => setAfterMoon(prev => !prev)}
      className={`absolute cursor-pointer z-10 xl:left-[10%]  lg:w-100 lg:h-100 bg-[url('/images/moon-8bit.png')] bg-cover bg-center
