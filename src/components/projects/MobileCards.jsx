...
const MobileCards = () => {
  ...
  return (
    <div
      className={`anim-cards flex overflow-hidden md:flex-row justify-center gap-5 w-[340px] h-[400px] md:w-[300px] md:h-[294px] md:mt-10 ${is8Bit ? "font-retro" : "font-fair uppercase"}`}
    >
              ...
              >
                ...
                <div className="flex flex-col w-full justify-between h-[270px] ">
                  <div className="flex justify-center  ">
                    <h1 className="bg-violet-950/90 shadow-coners p-2 rounded-b-2xl text-white text-[14px] ">
                      {project.name}
                    </h1>
                  </div>
                  <div className="mb-4">
